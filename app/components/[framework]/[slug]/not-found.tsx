      ...
      <main className="relative max-w-7xl mx-auto px-6 py-12 pt-32">
        ...
        <div className="text-center py-20">
          <div className="relative inline-block mb-8">
            ...
            <div className="absolute -inset-4 bg-linear-to-r from-red-500/10 to-pink-500/10 rounded-2xl blur-2xl opacity-50"></div>
          </div>
          ...
          <div className="flex items-center justify-center space-x-4">
            <Link href="/">
              <Button className="bg-linear-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white">
                Browse Components
              </Button>
            </Link>
            <Link href="/">
