  ...
  return (
    <div class="flex flex-col items-center space-y-6 max-w-sm mx-auto">
      ...
      <QrCode.Root value={vCardData} encoding={{ ecc: "M" }}>
        <QrCode.Frame class="w-48 h-48 bg-linear-to-br from-green-50 to-emerald-50 dark:from-green-900 dark:to-emerald-900 border border-green-200 dark:border-green-700 rounded-xl p-4 shadow-lg">
