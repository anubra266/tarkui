...
import { ChevronDownIcon, UserIcon } from "lucide-solid";
...
export default function ProfileSelector() {
  const [selectedProfile, setSelectedProfile] = createSignal<string>("sarah");
  ...
  const selectedProfileData = () =>
    profiles.find((profile) => profile.value === selectedProfile());
    ...
    <div class="bg-white dark:bg-gray-800 w-full px-4 py-12 rounded-xl flex items-center justify-center">
      <div class="max-w-sm w-full">
        ...
        >
          ...
          <Select.Control>
            <Select.Trigger class="flex min-h-12 w-full items-center justify-between rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:border-gray-900 dark:focus:border-gray-100 focus:outline-none focus:ring-1 focus:ring-gray-900 dark:focus:ring-gray-100">
