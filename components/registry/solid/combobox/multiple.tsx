            ...
            context().value.length > 0 && (
              <div class="flex flex-wrap gap-1.5 mb-2">
                <For each={context().value}>
                  {(item) => (
                    <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200 border border-blue-200 dark:border-blue-700">
                      {item}
                      <button
                        type="button"
                        onClick={() =>
