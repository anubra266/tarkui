...
export default function TooltipWithArrow() {
  return (
    <Tooltip.Root openDelay={0} closeDelay={0}>
      ...
      <Portal>
        <Tooltip.Positioner>
          <Tooltip.Content class="px-2 py-1 text-xs bg-gray-900 text-white rounded shadow-lg z-50 data-[state=open]:animate-fade-in data-[state=closed]:animate-fade-out [--background:var(--color-gray-900)]">
            <Tooltip.Arrow class="[--arrow-size:8px] [--arrow-background:var(--background)]">
              <Tooltip.ArrowTip class="rounded-xs " />
            </Tooltip.Arrow>
            With arrow
          </Tooltip.Content>
        </Tooltip.Positioner>
