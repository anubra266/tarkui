...
import { Building2, MapPin, Phone, Mail, Edit3 } from "lucide-solid";
    ...
    <div class="w-full max-w-md space-y-6">
      <div class="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div class="space-y-4">
          ...
          {/* Address */}
          <div class="group">
            <label class="flex items-center space-x-1 text-xs font-medium text-gray-500 dark:text-gray-400 mb-1 uppercase tracking-wide">
