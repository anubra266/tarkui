    ...
    <div class="w-full max-w-lg space-y-3">
      ...
      >
        ...
        <Editable.Area class="relative">
          ...
          <Editable.Preview class="w-full px-3 py-2 text-sm border border-transparent rounded-md bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white hover:border-gray-300 dark:hover:border-gray-600 cursor-text transition-colors min-h-[2.5rem] whitespace-pre-wrap" />
        </Editable.Area>
