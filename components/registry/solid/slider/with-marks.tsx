      ...
      <div class="max-w-md w-full">
        <Slider.Root defaultValue={[50]}>
          ...
          <Slider.Control class="relative flex items-center h-5">
            <Slider.Track class="relative flex-1 h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
              <Slider.Range class="absolute h-full bg-blue-600 dark:bg-blue-500 rounded-full" />
            </Slider.Track>
            <Slider.Thumb
              index={0}
          ...
          <Slider.MarkerGroup class="mt-[-4px] flex justify-between text-xs text-gray-500 dark:text-gray-400">
