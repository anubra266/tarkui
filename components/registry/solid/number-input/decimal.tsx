    ...
    <div class="flex items-center justify-center min-h-32">
      ...
      >
        ...
        <NumberInput.Control class="border border-gray-200 dark:border-gray-700 rounded-lg h-9 overflow-hidden grid grid-cols-[1fr_24px] grid-rows-2 focus-within:ring-2 focus-within:ring-blue-500/50 dark:focus-within:ring-blue-400/50 focus-within:border-blue-500/50 dark:focus-within:border-blue-400/50 transition-all">
          <NumberInput.Input class="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 font-mono text-sm px-3 py-1 row-span-2 border-none outline-none focus:outline-none focus-visible:outline-none" />
