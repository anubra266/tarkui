        ...
        <Dialog.Positioner class="fixed inset-0 z-50 flex items-center justify-center p-4">
          <Dialog.Content class="relative w-full max-w-sm rounded-lg bg-white dark:bg-gray-900 p-5 shadow-lg">
            ...
            <div class="space-y-4">
              ...
              <Dialog.CloseTrigger asChild>
                <button class="w-full px-3 py-2 text-sm bg-red-600 text-white hover:bg-red-700 rounded-md transition-colors cursor-pointer inline-flex items-center justify-center font-medium">
                  Continue
                </button>
              </Dialog.CloseTrigger>
            </div>
