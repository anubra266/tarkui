...
export default function DeleteProjectDialog() {
  ...
  createEffect(() => {
    setIsDeleteEnabled(projectName() === correctProjectName);
  });
          ...
          <Dialog.Content class="relative w-full max-w-sm rounded-lg bg-white dark:bg-gray-900 p-5 shadow-lg">
            ...
            <div class="space-y-4">
              <div class="flex items-start space-x-3">
                <div class="flex h-10 w-10 items-center justify-center rounded-full border border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-900/20">
              ...
              <div class="space-y-3">
                <div class="space-y-2">
                  <p class="text-sm text-gray-900 dark:text-white">
                    Please type{" "}
                    <span class="font-mono font-medium bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded text-xs">
                      {correctProjectName}
                    </span>{" "}
                    to confirm.
                  </p>
