                  ...
                  >
                    <For each={item.items}>
                      {(nestedItem) => (
                        ...
                        >
                          <Accordion.ItemTrigger class="w-full px-3 py-2 flex items-center justify-between text-left hover:bg-linear-to-r hover:from-blue-500/5 hover:to-purple-500/5 transition-all duration-200">
                            <div class="flex items-center">
                              <Dynamic
