...
import { User, Settings, LogOut, Mail, Phone, MapPin } from "lucide-solid";
...
export default function PopoverUserProfile() {
  ...
  return (
    <Popover.Root modal>
      ...
      <Portal>
        <Popover.Positioner>
          <Popover.Content class="z-50 w-72 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-lg data-[state=open]:animate-fade-in data-[state=closed]:animate-fade-out">
            ...
            <div class="border-b border-gray-200 dark:border-gray-700 p-3">
              <div class="flex items-center gap-3">
                <div class="relative">
                  ...
                  />
                  <div
                    class={`absolute -bottom-1 -right-1 h-3 w-3 rounded-full border-2 border-white dark:border-gray-800 ${
                      user.status === "online"
                        ? "bg-green-400"
                        : user.status === "away"
                        ? "bg-yellow-400"
