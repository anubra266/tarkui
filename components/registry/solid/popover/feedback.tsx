...
export default function PopoverFeedback() {
  ...
  return (
    <Popover.Root>
      ...
      <Portal>
        <Popover.Positioner>
          <Popover.Content class="z-50 w-80 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 shadow-lg data-[state=open]:animate-fade-in data-[state=closed]:animate-fade-out">
            ...
            <Popover.Title class="mb-3 text-lg font-semibold text-gray-900 dark:text-gray-100">
              Send us feedback
            </Popover.Title>

            {submitted() ? (
              <div class="py-6 text-center">
                <div class="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-green-100 dark:bg-green-900">
                  <svg
