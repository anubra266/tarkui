...
export default function PopoverNotifications() {
  const [notifications, setNotifications] = createSignal(mockNotifications);
  ...
  return (
    <Popover.Root>
      <Popover.Trigger class="relative inline-flex items-center justify-center rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 p-2 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
        <Bell size={20} />
        {unreadCount() > 0 && (
      ...
      <Portal>
        <Popover.Positioner>
          <Popover.Content class="z-50 w-80 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-lg data-[state=open]:animate-fade-in data-[state=closed]:animate-fade-out">
            ...
            <div class="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 p-3">
              <Popover.Title class="text-lg font-semibold text-gray-900 dark:text-gray-100">
                Notifications
              </Popover.Title>
              {unreadCount() > 0 && (
                <button
                ...
                {(notification) => (
                  ...
                  >
                    <div class="flex gap-3">
                      ...
                      {/* Unread indicator */}
                      {notification.unread && (
                        <div class="flex h-2 w-2 flex-shrink-0 items-center justify-center">
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 p-3">
              <button class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
