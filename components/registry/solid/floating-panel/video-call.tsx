          ...
          <FloatingPanel.Content class="bg-gray-900 border border-gray-700 rounded-lg shadow-lg overflow-hidden data-[stage=maximized]:rounded-none">
            <FloatingPanel.Header class="flex items-center justify-between p-3 bg-gray-800/50 backdrop-blur-sm">
              ...
              <div class="flex items-center gap-1">
                <FloatingPanel.MinimizeTrigger class="w-6 h-6 flex items-center justify-center text-gray-300 hover:text-white rounded hover:bg-white/10 transition-colors">
                  <Minus class="w-3 h-3" />
                </FloatingPanel.MinimizeTrigger>
                <FloatingPanel.MaximizeTrigger class="w-6 h-6 flex items-center justify-center text-gray-300 hover:text-white rounded hover:bg-white/10 transition-colors">
                  <Maximize2 class="w-3 h-3" />
                </FloatingPanel.MaximizeTrigger>
                <FloatingPanel.RestoreTrigger class="w-6 h-6 flex items-center justify-center text-gray-300 hover:text-white rounded hover:bg-white/10 transition-colors">
            ...
            <FloatingPanel.Body class="relative flex-1 bg-gradient-to-br from-blue-600 to-purple-700">
              ...
              <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2">
                <div class="flex items-center gap-3 p-3 bg-black/30 backdrop-blur-sm rounded-full">
                  ...
                  <button class="w-10 h-10 bg-red-500 hover:bg-red-600 rounded-full flex items-center justify-center text-white transition-colors">
                    <Phone class="w-4 h-4" />
                  </button>
                </div>
              </div>
