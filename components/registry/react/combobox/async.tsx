  ...
  return (
    <Combobox.RootProvider value={combobox} className="w-full max-w-sm">
      ...
      <Combobox.Control className="relative">
        <Combobox.Input className="w-full px-3 py-2 pr-20 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400" />
                ...
                collection.items.map((user) => (
                  ...
                  >
                    <div className="flex items-center">
                      <div className="flex-shrink-0 h-8 w-8 bg-blue-500 dark:bg-blue-600 rounded-full flex items-center justify-center text-white text-xs font-medium mr-3">
                        {user.avatar}
                      </div>
