          ...
          <PinInput.Control className="flex gap-3 justify-center mb-6">
            {[0, 1, 2, 3, 4, 5].map((_, index) => (
              <PinInput.Input
                key={index}
                index={index}
                className={`w-12 h-12 text-center text-lg font-medium border rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-hidden focus:ring-2 transition-all ${
                  isComplete
