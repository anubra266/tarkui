      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            readOnly
            className="flex-1 px-4 py-3 text-sm font-mono border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 shadow-sm"
          />
          <div
            className="w-14 h-12 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm"
        ...
        <div className="flex justify-center py-4">
          ...
          >
            ...
            >
              <AngleSlider.Thumb className="absolute top-0 right-0 bottom-0 left-[calc(50%-1.5px)] pointer-events-none h-full w-[3px] flex items-start outline-none">
                <span className="border-2 border-white size-5 rounded-full flex-shrink-0 shadow-gray-600 shadow-sm m-1.5" />
              </AngleSlider.Thumb>
            </AngleSlider.Control>
