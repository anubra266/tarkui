...
export default function InputWithEndInlineButton() {
  return (
    <Field.Root className="max-w-sm w-full">
      ...
      <div className="relative mt-1">
        ...
        />
        <button className="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-gray-100">
