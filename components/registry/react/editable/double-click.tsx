    ...
    <div className="w-full max-w-sm space-y-3">
      ...
      >
        ...
        <Editable.Area className="relative">
          ...
          <Editable.Preview className="w-full px-3 py-2 text-sm border border-dashed border-gray-300 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white hover:border-blue-400 dark:hover:border-blue-500 cursor-pointer transition-colors min-h-[2.5rem]" />
        </Editable.Area>
