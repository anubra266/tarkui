    ...
    <div className="w-full max-w-sm space-y-3">
      ...
      >
        ...
        <Editable.Area className="relative">
          ...
          <Editable.Preview className="w-full px-3 py-2 text-sm border border-transparent rounded-md bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white hover:border-gray-300 dark:hover:border-gray-600 cursor-text transition-colors min-h-[2.5rem]" />
        </Editable.Area>
      </Editable.Root>
    </div>
  );
