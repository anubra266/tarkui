    ...
    >
      {items.map((item, index) => (
        <Accordion.Item key={index} value={item} className="group">
          <Accordion.ItemTrigger className="w-full px-4 py-4 flex items-center text-left hover:bg-gradient-to-r hover:from-blue-500/5 hover:to-purple-500/5 transition-all duration-200 border-b border-gray-200/50 dark:border-gray-700/50">
            ...
            <div className="pl-7">
              {item === "Explore modern music production" ? (
                ...
                <div>
                  ...
                  and strategic planning that grows your wealth and protects
                  your assets.
                </div>
              ) : (
                <div>
                  Achieve conversational fluency through immersive practice,
                  cultural understanding, and proven language learning
