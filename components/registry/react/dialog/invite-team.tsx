                ...
                <div className="border-t border-gray-200 dark:border-gray-700 pt-3">
                  ...
                  <div className="flex">
                    <input
                      ...
                      value={magicLink}
                      readOnly
                      className="flex-1 px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-l-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none"
                    />
                    <button
