...
export default function BasicDatePicker() {
  return (
    ...
    >
      <DatePicker.Content className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm p-3 flex">
                      ...
                      <DatePicker.TableRow key={id}>
                        {week.map((day, id) => (
                          <DatePicker.TableCell
                            ...
                            className="pe-0 ps-0"
                          >
                            <DatePicker.TableCellTrigger className="relative w-9 h-9 text-sm text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 hover:rounded-lg transition-colors data-[in-range]:bg-gray-100 dark:data-[in-range]:bg-gray-700 data-[outside-range]:pointer-events-none data-[outside-range]:text-gray-400 dark:data-[outside-range]:text-gray-500 flex items-center justify-center font-medium data-[today]:after:content-[''] data-[today]:after:absolute data-[today]:after:bottom-0.5 data-[today]:after:w-1 data-[today]:after:h-1 data-[today]:after:bg-gray-900 data-[today]:after:rounded-full dark:data-[today]:after:bg-gray-300 data-[selected]:data-[today]:after:bg-white dark:data-[selected]:data-[today]:after:bg-gray-900 data-[in-range]:rounded-none data-[in-range]:data-[range-start]:bg-gray-900 data-[in-range]:data-[range-start]:text-white dark:data-[in-range]:data-[range-start]:bg-gray-200 dark:data-[in-range]:data-[range-start]:text-gray-900 data-[in-range]:data-[range-end]:bg-gray-900 data-[in-range]:data-[range-end]:text-white dark:data-[in-range]:data-[range-end]:bg-gray-200 dark:data-[in-range]:data-[range-end]:text-gray-900 data-[hover-range-start]:bg-gray-900 data-[hover-range-start]:text-white dark:data-[hover-range-start]:bg-gray-200 dark:data-[hover-range-start]:text-gray-900 data-[hover-range-end]:bg-gray-900 data-[hover-range-end]:text-white dark:data-[hover-range-end]:bg-gray-200 dark:data-[hover-range-end]:text-gray-900 data-[range-start]:rounded-l-lg data-[range-end]:rounded-r-lg data-[in-hover-range]:!rounded-none data-[hover-range-start]:!rounded-l-lg data-[hover-range-start]:!rounded-r-none data-[hover-range-end]:!rounded-r-lg data-[hover-range-end]:!rounded-l-none">
                              {day.day}
