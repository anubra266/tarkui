          ...
          {(api) => (
            <>
              <Moon
                ...
                className="w-4 h-4 transition-colors duration-200 text-gray-900 dark:text-gray-100 data-checked:text-gray-400 dark:data-checked:text-gray-500"
              />
              ...
              <Sun
                data-checked={api.checked ? "" : undefined}
                className="w-4 h-4 transition-colors duration-200 text-gray-400 dark:text-gray-500 data-checked:text-gray-900 dark:data-checked:text-gray-100"
              />
            </>
          )}
        </Switch.Context>
