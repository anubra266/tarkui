<script>
  ...
  function handleScroll() {
    ...
    if (scrollPercentage >= 0.99 && !state.hasReadToBottom) {
      state.hasReadToBottom = true;
    }
  }
</script>
...
<Dialog.Root>
  ...
  <Portal>
    ...
    >
      <Dialog.Content
        class="relative w-full max-w-lg h-[70vh] rounded-lg bg-white dark:bg-gray-900 shadow-lg flex flex-col"
      >
        <div
        ...
        >
          ...
          <div>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              ...
              account credentials. Any activities occurring under a user's
          ...
          <div>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              ...
              website owners shall not be liable for direct, indirect,
              incidental, consequential, or punitive damages arising from user
          ...
          <div>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              We are committed to protecting your privacy and personal data. All
              user information is handled according to our Privacy Policy and
              applicable data protection regulations. We do not sell or share
          ...
          <div>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              ...
              website after such changes constitutes acceptance of the modified
              terms.
            </p>
          </div>
        </div>
