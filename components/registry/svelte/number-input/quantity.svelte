...
<div class="flex items-center justify-center min-h-32">
  <NumberInput.Root class="">
    ...
    >
      ...
      <NumberInput.Input
        class="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 w-full grow px-3 py-2 text-center tabular-nums border-none outline-hidden focus:outline-hidden focus-visible:outline-hidden"
      />
      <NumberInput.IncrementTrigger
        class="-me-px flex aspect-square h-[inherit] items-center justify-center rounded-e-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-gray-100 text-sm transition-[color,box-shadow] disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50"
      >
        <Plus class="w-4 h-4" />
      </NumberInput.IncrementTrigger>
    </NumberInput.Control>
