    ...
    <Portal>
      <Menu.Positioner>
        ...
        >
          ...
          <Menu.Root>
            <Menu.TriggerItem
              class="flex items-center justify-between gap-3 px-3 py-2 text-sm text-gray-700 dark:text-gray-300 rounded-md data-highlighted:bg-gray-100 dark:data-highlighted:bg-gray-800 focus:bg-gray-100 dark:focus:bg-gray-800 cursor-pointer"
            >
