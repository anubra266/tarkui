...
<div class="space-y-6 p-6">
  ...
  <div class="space-y-3">
    ...
    <p class="text-sm text-gray-600 dark:text-gray-400">
      Current state: <span class="font-medium"
  ...
  <div class="flex items-center justify-center py-12">
    ...
    >
      <HoverCard.Trigger
        class="px-4 py-2 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors cursor-pointer"
      >
        Controlled Hover Card
      </HoverCard.Trigger>
        ...
        <HoverCard.Positioner>
          ...
          >
            <div class="space-y-3">
              ...
              <p class="text-sm text-gray-600 dark:text-gray-400">
                This hover card's open state is controlled externally via the
                buttons above.
              </p>
  ...
  >
    ...
    <p class="text-sm text-blue-700 dark:text-blue-300">
      ...
      externally. You can programmatically show or hide the hover card using the
      buttons above, and the state is synchronized between the hover behavior
