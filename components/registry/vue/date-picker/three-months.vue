    ...
    >
      ...
      >
        ...
        <DatePicker.Context v-slot="api">
          <div
            v-for="(_, index) in Array.from({ length: NUM_OF_MONTHS })"
            :key="index"
            class="px-3"
          >
                ...
                <span>
                  {{
                    new Intl.DateTimeFormat("default", {
                      ...
                      api
                        .getOffset({ months: index })
                        .visibleRange.start.toDate("UTC")
                    )
                  }}
                  {{ api.getOffset({ months: index }).visibleRange.start.year }}
                </span>
              </DatePicker.ViewTrigger>
            </DatePicker.ViewControl>
            <DatePicker.Table>
              ...
              <DatePicker.TableBody>
                <DatePicker.TableRow
                  v-for="(week, id) in api.getOffset({ months: index }).weeks"
                  :key="id"
                >
                  <DatePicker.TableCell
                    ...
                    class="pe-0 ps-0"
                    :visible-range="
                      api.getOffset({ months: index }).visibleRange
                    "
                  >
