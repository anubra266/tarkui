...
<template>
  <RadioGroup.Root class="flex flex-col space-y-3" default-value="visa">
    <RadioGroup.Item
    ...
    >
      ...
      >
        ...
        <div
          class="w-3 h-3 bg-orange-400 rounded-full -ml-1.5 opacity-80"
        ></div>
      </div>
      <div
        v-else-if="option.value === 'visa'"
        class="w-8 h-6 bg-blue-600 rounded-sm flex items-center justify-center text-white text-xs font-bold"
      >
        VISA
      </div>
