...
<template>
  <RadioGroup.Root class="flex flex-col space-y-3" default-value="option1">
    <RadioGroup.Item
    ...
    >
      ...
      <RadioGroup.ItemText
        class="text-sm font-medium text-gray-900 dark:text-gray-100 data-disabled:text-gray-400 dark:data-disabled:text-gray-500"
      >
        {{ option.label }}
      </RadioGroup.ItemText>
