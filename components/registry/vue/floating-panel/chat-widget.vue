...
import { Send, ArrowDownLeft, Maximize2, Minus, X } from "lucide-vue-next";
import { ref } from "vue";
...
const messages = [
  ...
  { id: 3, text: "I'd be happy to help! What would you like to know?", isUser: false },
];
...
<template>
  <div class="relative h-96">
    <FloatingPanel.Root
      :default-size="{ width: 360, height: 480 }"
      :min-size="{ width: 320, height: 400 }"
            ...
            <div class="p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
              <div class="flex gap-2">
                <input
                  ...
                  class="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100"
                />
                <button
                  @click="handleSend"
