    ...
    >
      ...
      >
        ...
        <NumberInput.IncrementTrigger
          class="flex items-center justify-center bg-white dark:bg-gray-900 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-gray-100 transition-colors cursor-pointer border-l border-gray-200 dark:border-gray-700 data-disabled:opacity-50 data-disabled:cursor-not-allowed"
        >
      ...
      <div
        class="flex justify-between text-xs text-gray-500 dark:text-gray-400 mt-3"
      >
        <span>Min: 0</span>
        <span>Max: 10</span>
      </div>
