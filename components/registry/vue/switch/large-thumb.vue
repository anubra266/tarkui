<template>
  ...
  >
    <Switch.Root class="flex items-center gap-3">
      ...
      >
        <Switch.Thumb
          class="w-6 h-6 rounded-full bg-white shadow-lg border border-gray-200 transition-transform duration-200 ease-in-out data-[state=checked]:translate-x-5 dark:border-gray-300"
        />
      </Switch.Control>
      <Switch.HiddenInput />
    </Switch.Root>
