    ...
    <div class="max-w-sm w-full">
      ...
      >
        ...
        <Teleport to="body">
          <Select.Positioner>
            <Select.Content
              class="z-50 min-w-(--reference-width) rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-lg max-h-60 overflow-auto"
            >
              <Select.ItemGroup>
...
import { ChevronDownIcon, UserIcon } from "lucide-vue-next";
...
const selectedProfile = ref<string>("sarah");
...
const selectedProfileData = computed(() =>
  profiles.find((profile) => profile.value === selectedProfile.value)
);

const handleValueChange = (e: any) => {
  selectedProfile.value = e.value[0] || "sarah";
};
</script>
