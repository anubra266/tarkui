...
import { Clipboard, FileText, X } from "lucide-vue-next";
...
onMounted(() => {
  const handlePaste = (event: ClipboardEvent) => {
    ...
    // Note: This would need to be handled differently in Vue
    // as we don't have direct access to the FileUpload context here
    isPasted.value = true;
    setTimeout(() => {
...
<template>
  <FileUpload.Root :max-files="5" class="w-full max-w-2xl">
      ...
      <div class="space-y-4">
        ...
        >
          ...
          <div class="text-center space-y-2">
            ...
            <div
              class="flex items-center justify-center gap-4 text-xs text-gray-500 dark:text-gray-400"
            >
          ...
          <div
            v-if="isPasted"
            class="absolute inset-0 bg-green-50 dark:bg-green-900/20 border-2 border-green-300 dark:border-green-600 rounded-xl flex items-center justify-center"
          >
            <div
              class="flex items-center gap-2 text-green-700 dark:text-green-300 text-sm font-medium"
            >
        ...
        <!-- Files List -->
        <div v-if="context.acceptedFiles.length > 0" class="space-y-2">
            ...
            <div class="space-y-2">
              ...
              >
                ...
                >
                  ...
                  <div
                    class="w-10 h-10 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 flex items-center justify-center flex-shrink-0 overflow-hidden"
                  >
