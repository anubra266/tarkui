...
import { X, ShoppingBag, CreditCard } from "lucide-vue-next";
          ...
          <div class="space-y-4">
            ...
            <div class="space-y-4">
              ...
              <div class="space-y-1">
                ...
                <input
                  type="text"
                  v-model="state.paymentData.nameOnCard"
              ...
              <div class="space-y-2">
                ...
                <div class="relative">
                  <input
                    ...
                    v-model="state.paymentData.cardNumber"
                ...
                <div class="grid grid-cols-2 gap-3">
                  <input
                    type="text"
                    placeholder="MM/YY"
                    v-model="state.paymentData.expiryDate"
