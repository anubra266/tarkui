<template>
  ...
  >
    ...
    >
      ...
      <TagsInput.Control
        class="flex flex-wrap gap-1 p-2 border border-gray-300 rounded-md bg-white dark:bg-gray-900 dark:border-gray-600 min-h-[2rem]"
      >
        <TagsInput.Item
      ...
      <TagsInput.ClearTrigger
        v-if="api.value.length > 0"
        class="mt-1 text-xs text-gray-500 hover:text-gray-700 transition-colors dark:text-gray-400 dark:hover:text-gray-200"
      >
        Clear all
      </TagsInput.ClearTrigger>
