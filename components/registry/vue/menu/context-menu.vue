...
import { Copy, Scissors, ClipboardPaste, Trash2, Info } from "lucide-vue-next";
</script>
...
<template>
  <div class="flex items-center justify-center min-h-32">
    <Menu.Root>
      <Menu.ContextTrigger
        class="flex items-center justify-center w-64 h-32 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-gray-600 dark:text-gray-400 text-sm cursor-context-menu"
      >
