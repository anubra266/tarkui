...
<template>
  <div class="flex items-center justify-center min-h-32">
    ...
    >
      ...
      <Listbox.Content
        class="bg-[var(--listbox-bg)] border border-[var(--listbox-border)] rounded-lg px-1 py-2 w-80 shadow-lg max-h-64 overflow-y-auto"
      >
        <Listbox.Item
          v-for="country in collection.items"
          :key="country.code"
          :item="country"
