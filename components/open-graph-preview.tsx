...
export const OpenGraphPreview = () => {
  return (
    <div className="w-[900px] h-[572px] mx-auto bg-gradient-to-br from-gray-900 via-purple-900/20 to-blue-900/20 overflow-hidden shadow-2xl border border-gray-700/50">
      {/* Header Section */}
      ...
      <div className="px-8 pb-8 mt-4">
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center space-x-3 px-6 py-3 bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 rounded-full">
